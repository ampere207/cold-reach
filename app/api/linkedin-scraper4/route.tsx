...
const buildApiUrl = (linkedinUrl: string) => {
  ...
  return `https://${RAPIDAPI_HOST}/get-recommendations-received?linkedin_url=${encodedUrl}`
}
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    if (!res.ok) {
      ...
      console.error('❌ LinkedIn Recommendations Received API Error:', res.status, text)
